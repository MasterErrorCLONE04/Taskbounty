...
export default function PayTaskPage({ params }: { params: Promise<{ id: string }> }) {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-background p-6 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-primary/10 via-background to-background">
