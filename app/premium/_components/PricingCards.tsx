...
const PricingCards: React.FC<PricingCardsProps> = ({ plans, selectedTier, onSelect, currentPlan }) => {
    return (
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-20 items-stretch">
            {plans.map((plan) => (
                <div
                    ...
                    className={`relative group cursor-pointer bg-white/[0.03] border rounded-[32px] p-8 flex flex-col transition-all duration-300 ${currentPlan === plan.id
