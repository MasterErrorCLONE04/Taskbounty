    ...
    return (
        <>
            ...
            <ConfirmModal
                ...
                onConfirmAction={handleActivate}
                title="¿Activar tarea manualmente?"
                description="Esto forzará la activación de la tarea sin verificación de pago. Solo para desarrollo."
                confirmText="Activar"
                cancelText="Cancelar"
                variant="warning"
                isLoading={loading}
