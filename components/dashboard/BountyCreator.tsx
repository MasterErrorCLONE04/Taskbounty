    ...
    return (
        <div className="bg-white rounded-xl border border-slate-200 p-5 shadow-sm mb-4">
            <div className="flex gap-4 mb-5">
                ...
                <button className="flex-1 bg-slate-50 hover:bg-slate-100 border border-slate-100 rounded-xl px-6 text-left text-sm font-medium text-slate-400 transition-all">
            ...
            <div className="flex items-center justify-between border-t border-slate-50 pt-4">
                ...
                <button className="bg-sky-500 hover:bg-sky-600 text-white px-8 py-2.5 rounded-full text-xs font-black uppercase tracking-widest shadow-lg shadow-sky-500/20 transition-all active:scale-95 flex items-center gap-2">
                    Post Bounty
                </button>
            </div>
        </div>
